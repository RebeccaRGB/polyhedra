...
public abstract class FacePredicate {
	...
	public static enum Builtin {
		DEGREE ("n", Type.INTS, "only operate on faces with the specified number of edges") {
			...
			public FacePredicate predicate(Object arg) {
		...
		public abstract FacePredicate predicate(Object arg);
		...
		public final FacePredicate parse(String s) { return predicate(parseArgument(s)); }
