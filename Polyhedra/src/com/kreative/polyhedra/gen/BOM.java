...
public class BOM {
	...
	public static final Map<String,Class<? extends PolyhedronGen>> CON = Collections.unmodifiableMap(
		Arrayz.asMap(
			...
			// Arrayz.mapEntry("D*", SmallStellatedDodecahedron.class),
			// Arrayz.mapEntry("E", GreatDodecahedron.class),
			// Arrayz.mapEntry("E*", GreatStellatedDodecahedron.class),
			// Arrayz.mapEntry("H", Hextille.class),
			Arrayz.mapEntry("I", Icosahedron.class),
			// Arrayz.mapEntry("J", GreatIcosahedron.class),
