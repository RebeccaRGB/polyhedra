...
public class Anticupola extends PolyhedronGen {
	...
	public Anticupola(int n, double R, double r, Axis axis, double h, Color c) {
		this(n, R, r, axis, h, c, c);
	}
	public Anticupola(int n, double R, double r, Axis axis, double h, Color base, Color join) {
		this.n = n;
		this.R = R;
		this.r = r;
		this.axis = axis;
	...
	public Polyhedron gen() {
		...
		Polygon.createVertices(vertices, n*2, R, 0, axis, -h/2);
	...
	public static class Factory extends PolyhedronGen.Factory<Anticupola> {
		...
		public Anticupola parse(String[] args) {
			...
			double r = spec.toRadius(size, n);
			return new Anticupola(n, R, r, axis, h, ((bc != null) ? bc : c), ((jc != null) ? jc : c));
		}
