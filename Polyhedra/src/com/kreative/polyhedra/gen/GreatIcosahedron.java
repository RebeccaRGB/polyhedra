...
public class GreatIcosahedron extends PolyhedronGen {
	...
	private static final double INRADIUS_FACTOR = 0.11026408970826791628; // (3*sqrt(3)−sqrt(15))/12
	...
	public GreatIcosahedron(SizeSpecifier spec, double size, Color color) {
	...
	public Polyhedron gen() {
		return new Polyhedron(
			...
			Arrays.asList(
				...
				Arrays.asList(0, 5, 1),
				Arrays.asList(0, 7, 9),
				Arrays.asList(0, 9, 11),
				Arrays.asList(0, 11, 5),
				Arrays.asList(1, 5, 10),
				Arrays.asList(1, 8, 7),
				Arrays.asList(1, 10, 8),
				Arrays.asList(2, 3, 4),
				Arrays.asList(2, 4, 11),
				Arrays.asList(2, 6, 3),
				Arrays.asList(2, 9, 6),
				Arrays.asList(2, 11, 9),
				Arrays.asList(3, 6, 8),
				Arrays.asList(3, 8, 10),
				Arrays.asList(3, 10, 4),
	...
	public static class Factory extends PolyhedronGen.Factory<GreatIcosahedron> {
		public String name() { return "GreatIcosahedron"; }
		
		public GreatIcosahedron parse(String[] args) {
			...
			return new GreatIcosahedron(spec, size, c);
		}
